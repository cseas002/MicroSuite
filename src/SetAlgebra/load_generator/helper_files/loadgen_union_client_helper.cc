...
void UpdateGlobalUtilStats(PercentUtilInfo * percent_util_info,
                           ...
                           GlobalStats *global_stats) void UpdateGlobalUtilStats(PercentUtilInfo * percent_util_info,
                                                                                 const unsigned int number_of_intersection_servers,
                                                                                 GlobalStats *global_stats)
{
...
void ResetMetaStats(GlobalStats * meta_stats,
                    int number_of_intersection_servers) void ResetMetaStats(GlobalStats * meta_stats,
